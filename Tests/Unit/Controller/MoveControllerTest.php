...
/**
 * Test case for class ChallengeTeam\Challenge\Controller\MoveController.
 *
...
class MoveControllerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
	...
	/**
	 * @var \ChallengeTeam\Challenge\Controller\MoveController
	 */
	protected $subject = NULL;

	public function setUp()
	{
		$this->subject = $this->getMock('ChallengeTeam\\Challenge\\Controller\\MoveController', array('redirect', 'forward', 'addFlashMessage'), array(), '', FALSE);
	}
	...
	public function listActionFetchesAllmovesFromRepositoryAndAssignsThemToView()
	{
		...
		$moveRepository = $this->getMock('ChallengeTeam\\Challenge\\Domain\\Repository\\MoveRepository', array('findAll'), array(), '', FALSE);
	...
	{
		$move = new \ChallengeTeam\Challenge\Domain\Model\Move();
	...
	public function createActionAddsTheGivenMoveToMoveRepository()
	{
		...
		$moveRepository = $this->getMock('ChallengeTeam\\Challenge\\Domain\\Repository\\MoveRepository', array('add'), array(), '', FALSE);
	...
	public function updateActionUpdatesTheGivenMoveInMoveRepository()
	{
		...
		$moveRepository = $this->getMock('ChallengeTeam\\Challenge\\Domain\\Repository\\MoveRepository', array('update'), array(), '', FALSE);
	...
	public function deleteActionRemovesTheGivenMoveFromMoveRepository()
	{
		...
		$moveRepository = $this->getMock('ChallengeTeam\\Challenge\\Domain\\Repository\\MoveRepository', array('remove'), array(), '', FALSE);
