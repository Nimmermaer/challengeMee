...
/**
 * Test case for class ChallengeTeam\Challenge\Controller\TableController.
 *
...
class TableControllerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
	...
	/**
	 * @var \ChallengeTeam\Challenge\Controller\TableController
	 */
	protected $subject = NULL;

	public function setUp()
	{
		$this->subject = $this->getMock('ChallengeTeam\\Challenge\\Controller\\TableController', array('redirect', 'forward', 'addFlashMessage'), array(), '', FALSE);
	}
	...
	public function listActionFetchesAllTablesFromRepositoryAndAssignsThemToView()
	{
		...
		$tableRepository = $this->getMock('ChallengeTeam\\Challenge\\Domain\\Repository\\TableRepository', array('findAll'), array(), '', FALSE);
	...
	{
		$table = new \ChallengeTeam\Challenge\Domain\Model\Table();
	...
	public function createActionAddsTheGivenTableToTableRepository()
	{
		...
		$tableRepository = $this->getMock('ChallengeTeam\\Challenge\\Domain\\Repository\\TableRepository', array('add'), array(), '', FALSE);
	...
	public function updateActionUpdatesTheGivenTableInTableRepository()
	{
		...
		$tableRepository = $this->getMock('ChallengeTeam\\Challenge\\Domain\\Repository\\TableRepository', array('update'), array(), '', FALSE);
	...
	public function deleteActionRemovesTheGivenTableFromTableRepository()
	{
		...
		$tableRepository = $this->getMock('ChallengeTeam\\Challenge\\Domain\\Repository\\TableRepository', array('remove'), array(), '', FALSE);
