...
class PlayerController extends \TYPO3\CMS\Extbase\Mvc\Controller\ActionController
{
     ...
     * playerRepository
     * 
     * @var \ChallengeTeam\Challenge\Domain\Repository\PlayerRepository
     * @inject
     */
     ...
     * action show
     * 
     * @param \ChallengeTeam\Challenge\Domain\Model\Player $player
     * @return void
     */
    public function showAction(\ChallengeTeam\Challenge\Domain\Model\Player $player)
    {
     ...
     * action create
     * 
     * @param \ChallengeTeam\Challenge\Domain\Model\Player $newPlayer
     * @return void
     */
    public function createAction(\ChallengeTeam\Challenge\Domain\Model\Player $newPlayer)
    {
     ...
     * @return void
     */
    public function editAction(\ChallengeTeam\Challenge\Domain\Model\Player $player)
    {
        $this->view->assign('player', $player);
    }
     ...
     * @return void
     */
    public function updateAction(\ChallengeTeam\Challenge\Domain\Model\Player $player)
    {
     ...
     * @return void
     */
    public function deleteAction(\ChallengeTeam\Challenge\Domain\Model\Player $player)
    {
