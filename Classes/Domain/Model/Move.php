...
class Move extends \TYPO3\CMS\Extbase\DomainObject\AbstractEntity
{
     ...
     * @return void
     */
    public function addPlayer(\ChallengeTeam\Challenge\Domain\Model\Player $player)
    {
     ...
     * Removes a Player
     * 
     * @param \ChallengeTeam\Challenge\Domain\Model\Player $playerToRemove The Player to be removed
     * @return void
     */
    public function removePlayer(\ChallengeTeam\Challenge\Domain\Model\Player $playerToRemove)
    {
     ...
     * Returns the player
     * 
     * @return \TYPO3\CMS\Extbase\Persistence\ObjectStorage<\ChallengeTeam\Challenge\Domain\Model\Player> $player
     */
     ...
     * Sets the player
     * 
     * @param \TYPO3\CMS\Extbase\Persistence\ObjectStorage<\ChallengeTeam\Challenge\Domain\Model\Player> $player
     * @return void
     */
