...
/**
 * Test case for class ChallengeTeam\Challenge\Controller\ChallengeController.
 *
...
class ChallengeControllerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
	...
	/**
	 * @var \ChallengeTeam\Challenge\Controller\ChallengeController
	 */
	protected $subject = NULL;

	public function setUp()
	{
		$this->subject = $this->getMock('ChallengeTeam\\Challenge\\Controller\\ChallengeController', array('redirect', 'forward', 'addFlashMessage'), array(), '', FALSE);
	}
	...
	public function listActionFetchesAllChallengesFromRepositoryAndAssignsThemToView()
	{
		...
		$challengeRepository = $this->getMock('ChallengeTeam\\Challenge\\Domain\\Repository\\ChallengeRepository', array('findAll'), array(), '', FALSE);
	...
	public function createActionAddsTheGivenChallengeToChallengeRepository()
	{
		...
		$challengeRepository = $this->getMock('ChallengeTeam\\Challenge\\Domain\\Repository\\ChallengeRepository', array('add'), array(), '', FALSE);
	...
	public function updateActionUpdatesTheGivenChallengeInChallengeRepository()
	{
		...
		$challengeRepository = $this->getMock('ChallengeTeam\\Challenge\\Domain\\Repository\\ChallengeRepository', array('update'), array(), '', FALSE);
	...
	public function deleteActionRemovesTheGivenChallengeFromChallengeRepository()
	{
		...
		$challengeRepository = $this->getMock('ChallengeTeam\\Challenge\\Domain\\Repository\\ChallengeRepository', array('remove'), array(), '', FALSE);
